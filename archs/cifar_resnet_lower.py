...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes=1000, block_name='BasicBlock'):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.BasicBlock11_s = BasicBlock(32, 32)
        self.BasicBlock12_s = BasicBlock(32, 32)
        self.BasicBlock13_s = BasicBlock(32, 32)
        self.BasicBlock21 = BasicBlock(32, 64,2,downsample1)
        self.BasicBlock22 = BasicBlock(64, 64,stride=1)
        self.BasicBlock23 = BasicBlock(64, 64,stride=1)
        self.BasicBlock31 = BasicBlock(64, 128,2,downsample2)
        self.BasicBlock32 = BasicBlock(128, 128,stride=1)
        self.BasicBlock33 = BasicBlock(128, 128,stride=1)
