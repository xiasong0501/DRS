...
if __name__ == "__main__":
    latex_table_certified_accuracy(
        "analysis/latex/vary_noise_cifar10", 0.25, 1.5, 0.25, [
            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25_withAdam"), "$\sigma = 0.25A$"),
#            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25_withsoftmax"), "$\sigma = 0.25S$"),
            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25_MSEsoftmax"), "$\sigma = 0.25S$"),
#            Line(ApproximateAccuracy("data/certify/cifar10/resnet110/noise_1.00/test/sigma_1.00"), "$\sigma = 1.00$"),
    ...
    markdown_table_certified_accuracy(
        "analysis/markdown/vary_noise_cifar10", 0.25, 1.5, 0.25, [
            Line(ApproximateAccuracy("data\certify\cifar10\resnet20\noise_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("data\certify\cifar10\resnet20\noise_0.25_withAdam"), "$\sigma = 0.25A$"),
            Line(ApproximateAccuracy("data\certify\cifar10\resnet20\noise_0.25_withsoftmax"), "$\sigma = 0.25S$"),
            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25_MSEsoftmax"), "$\sigma = 0.25S$"),
        ])
#    latex_table_certified_accuracy(
...
#        ])
    plot_certified_accuracy(
        "analysis/plots/vary_noise_cifar10_com", "CIFAR-10, vary $\sigma$", 1.5, [
            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25_withAdam"), "$\sigma = 0.25A$"),
#            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25_withsoftmax"), "$\sigma = 0.25S$"),
            Line(ApproximateAccuracy("data/certify/cifar10/resnet20/noise_0.25_MSEsoftmax"), "$\sigma = 0.25S$"),
...
#        ])
    ...
    plot_certified_accuracy(
        "analysis/plots/vary_noise_cifar10_com_0.50", "CIFAR-10, $\sigma$=0.25", 2.5, [
            Line(ApproximateAccuracy("data/predict/cifar10/resnet20/resnet110_0.50/sigma1"), "ours"),
            Line(ApproximateAccuracy("data/certify/cifar10/resnet110/noise_0.50/test/sigma_0.50"), "cohen",plot_fmt=':'),
            Line(ApproximateAccuracy("data/PGD_10steps255/resnet110/noise_0.50/test/sigma_0.50"), "Salman_$\epsilon =1.00$",plot_fmt='--'),
            Line(ApproximateAccuracy("data/PGD10_64/noise_0.50/test/sigma_0.50"), "Salman_$\epsilon = 0.25$",plot_fmt='--'),
#            Line(ApproximateAccuracy("data/certify/cifar10/resnet110/noise_1.00/test/sigma_1.00"), "$\sigma = 1.00$")
        ])